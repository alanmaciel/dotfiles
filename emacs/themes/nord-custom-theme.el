...
;;;; Color Constants
(let ((class '((class color) (min-colors 89))),"#181c26"
  ;; (nord0 (if (display-graphic-p) "#2E3440" nil))
  (nord0 (if (display-graphic-p) "#181c26" nil))
  ...
  (nord14 (if (display-graphic-p) "#D0F4E3" "green"))
  (nord15 (if (display-graphic-p) "#B48EAD" "magenta"))
  (nord-annotation (if (display-graphic-p) "#D08770" "brightyellow"))
  (nord-attribute (if (display-graphic-p) "#eaedde" "cyan"))
  (nord-class (if (display-graphic-p) "#88C0D0" "brightcyan"))
  ...
  (nord-method (if (display-graphic-p) "#81A1C1" "blue"))
  (nord-keyword (if (display-graphic-p) "#88c0d0" "brightcyan"))
  ...
  (nord-string (if (display-graphic-p) "#cdf1f2" "green"))
...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(default ((,class (:foreground ,nord4 :background ,"#181c26"))))
    ...
    `(font-lock-keyword-face ((,class (:foreground ,nord10))))
    ...
    `(font-lock-type-face ((,class (:foreground ,nord6))))
    `(font-lock-variable-name-face ((,class (:foreground ,"#cdf1f2"))))
    ...
    `(fringe ((,class (:foreground ,nord4 :background ,"#181c26"))))
    ...
    `(linum ((,class (:foreground ,nord3 :background ,"#181c26"))))
    ...
    `(show-paren-mismatch ((t (:background "#9FCCFF" :foreground "#000"))))
    `(show-paren-match ((t (:background "#9FCCFF" :foreground "#000"))))
